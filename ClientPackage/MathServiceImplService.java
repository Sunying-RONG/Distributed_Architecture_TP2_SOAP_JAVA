 ...
 * 
 */
@WebServiceClient(name = "MathServiceImplService", targetNamespace = "http://ServerPackage/", wsdlLocation = "http://localhost:8080/mathservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MATHSERVICEIMPLSERVICE_QNAME = new QName("http://ServerPackage/", "MathServiceImplService");
    ...
    public IMathService getMathServiceImplPort() {
        return super.getPort(new QName("http://ServerPackage/", "MathServiceImplPort"), IMathService.class);
    }
    ...
    public IMathService getMathServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServerPackage/", "MathServiceImplPort"), IMathService.class, features);
    }
