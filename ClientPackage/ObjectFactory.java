 ...
 * generated in the ClientPackage package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://ServerPackage/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://ServerPackage/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://ServerPackage/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ServerPackage/", "multiplyResponse");
    private final static QName _Add_QNAME = new QName("http://ServerPackage/", "add");
    private final static QName _Multiply_QNAME = new QName("http://ServerPackage/", "multiply");
    private final static QName _DivideResponse_QNAME = new QName("http://ServerPackage/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://ServerPackage/", "divide");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ClientPackage
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ServerPackage/", name = "divide")
