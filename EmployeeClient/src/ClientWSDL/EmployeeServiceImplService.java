 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://service/", "EmployeeServiceImplService");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://service/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }
